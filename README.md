...
![图1 新建数据库用户（区别于系统用户）](https://github.com/LoftyCloud/autotrans/blob/main/image/clip_image002.jpg)
...
![图2 gorm迁移创建的数据表](https://github.com/LoftyCloud/autotrans/blob/main/image/clip_image004.jpg)
